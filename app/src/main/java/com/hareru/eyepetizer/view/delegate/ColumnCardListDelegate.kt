...
@Deprecated("...")
class ColumnCardListDelegate : IDelegate {
    ...
    override fun isForViewType(item: BasicItem): Boolean {
        return item.type == "columnCardList"
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, item: BasicItem) {
        ...
        binding.rv.layoutManager = GridLayoutManager(binding.root.context, 2, RecyclerView.VERTICAL, false)
        scope.launch {
