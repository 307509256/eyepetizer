...
@Deprecated()
public class AutoPlayVideo extends StandardGSYVideoPlayer {
    ...
    public AutoPlayVideo(Context context, Boolean fullFlag) {
    ...
    public AutoPlayVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void loadCoverImage(String url, int res) {
        mCoverOriginUrl = url;
        mDefaultRes = res;
        ImageLoader imageLoader = Coil.imageLoader(mContext);
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        AutoPlayVideo autoPlayVideo = (AutoPlayVideo) gsyBaseVideoPlayer;
        if (mCoverOriginUrl != null) {
            autoPlayVideo.loadCoverImage(mCoverOriginUrl, mDefaultRes);
        } else if (mCoverOriginId != 0) {
            autoPlayVideo.loadCoverImageBy(mCoverOriginId, mDefaultRes);
        }
    ...
    public GSYBaseVideoPlayer showSmallVideo(Point size, boolean actionBar, boolean statusBar) {
        //下面这里替换成你自己的强制转化
        AutoPlayVideo autoPlayVideo = (AutoPlayVideo) super.showSmallVideo(size, actionBar, statusBar);
        autoPlayVideo.mStartButton.setVisibility(GONE);
        autoPlayVideo.mStartButton = null;
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        AutoPlayVideo sf = (AutoPlayVideo) from;
        AutoPlayVideo st = (AutoPlayVideo) to;
    ...
    protected void clearFullscreenLayout() {
        ...
        if (oldF != null) {
            ...
            AutoPlayVideo gsyVideoPlayer = (AutoPlayVideo) oldF;
